...
export default function GuestConverterPage() {
    return (
        <div className="space-y-6 animate-fade-in">
            {/* Header */}
            <div>
                <h1 className="text-4xl font-bold text-orange-950 tracking-tighter uppercase">Alih Audio</h1>
                <p className="text-orange-900/50 text-xs font-medium uppercase tracking-widest mt-1">Konversi teks menjadi audio (Mode Tamu)</p>
            </div>
