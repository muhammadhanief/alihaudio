...
export default function DashboardPage() {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            {/* Header */}
            <div>
                <h1 className="text-4xl font-black text-orange-950 tracking-tighter uppercase">Beranda</h1>
                <p className="text-orange-900/50 text-xs font-bold uppercase tracking-widest mt-1">Ringkasan Aktivitas Anda</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass p-6 rounded-[32px] border border-orange-200/50 shadow-xl flex items-center justify-between group hover:scale-[1.02] transition-all">
                    <div>
                        <p className="text-[10px] font-black text-orange-900/40 uppercase tracking-widest mb-1">Total Konversi</p>
                        <h3 className="text-4xl font-black text-orange-950">{stats.total}</h3>
                    </div>
                ...
                <div className="glass p-6 rounded-[32px] border border-orange-200/50 shadow-xl flex items-center justify-between group hover:scale-[1.02] transition-all">
                    <div>
                        <p className="text-[10px] font-black text-orange-900/40 uppercase tracking-widest mb-1">Bahasa Berbeda</p>
                        <h3 className="text-4xl font-black text-orange-950">
                ...
                <div className="glass p-6 rounded-[32px] border border-orange-200/50 shadow-xl flex items-center justify-between group hover:scale-[1.02] transition-all">
                    <div>
                        <p className="text-[10px] font-black text-orange-900/40 uppercase tracking-widest mb-1">Aktivitas Mingguan</p>
                        <h3 className="text-4xl font-black text-orange-950">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="glass p-8 rounded-[40px] border border-orange-200/50 shadow-xl bg-gradient-to-br from-orange-600 to-orange-700 relative overflow-hidden">
                    <div className="relative z-10 text-white">
                        <h4 className="text-sm font-black uppercase tracking-widest mb-4 opacity-70">Tips Penggunaan</h4>
                        <p className="text-2xl font-black tracking-tight leading-tight mb-6">
                            Gunakan mode "Laki-laki" untuk narasi berita yang lebih berwibawa.
                        </p>
                        <button
                            onClick={() => window.location.href = getAssetUrl('/converter')}
                            className="px-6 py-3 bg-white text-orange-600 rounded-xl text-xs font-black uppercase tracking-widest shadow-xl shadow-black/10 hover:scale-105 active:scale-95 transition-all"
                        >
                            Coba Sekarang
                        </button>
                    </div>
