...
import { Mic2, PlayCircle, Download, Clock, Code, Check, Search, ArrowUpDown, ArrowUp, ArrowDown, Eye, Globe } from "lucide-react";
...
export default function MyConversionsPage() {
    ...
    const fetchConversions = () => {
        fetch(getApiUrl(`/api/my-conversions?_t=${Date.now()}`), { cache: "no-store", headers: { 'Cache-Control': 'no-cache' } })
            .then(res => res.json())
            .then(data => {
    ...
    return (
        <div className="space-y-5 animate-fade-in">
            ...
            <div>
                ...
                <p className="text-orange-900/50 text-xs font-semibold uppercase tracking-widest mt-1">Daftar riwayat konversi Anda</p>
            </div>
