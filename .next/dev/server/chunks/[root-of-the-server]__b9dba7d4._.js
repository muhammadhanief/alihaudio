...
async function GET() {
    try {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT role FROM users WHERE nipp = ?", [
            nipp
        ]);
        ...
        const [users] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT nipp, nip_lama, nama, foto_url, satker, kd_satker, role, last_login FROM users ORDER BY last_login DESC");
...
async function POST(req) {
    try {
        ...
        const [currentUserRows] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT role FROM users WHERE nipp = ?", [
            currentUserNipp
        ]);
        ...
        const [targetUserRows] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT role FROM users WHERE nipp = ?", [
            targetNipp
        ]);
        ...
        if (targetNipp !== currentUserNipp && targetUserRole === currentUserRole) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Anda tidak diberikan hak untuk mengubah peran pengguna yang memiliki tingkatan role setara."
            }, {
                status: 403
            });
        }
        if (targetNipp === currentUserNipp && newRole !== 'superadmin') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Tidak dapat menurunkan hak akses (demote) akun Anda sendiri"
            }, {
                status: 400
            });
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("UPDATE users SET role = ? WHERE nipp = ?", [
            newRole,
            targetNipp
        ]);
        const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b9dba7d4._.js.map