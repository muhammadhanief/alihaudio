module.exports = [
"[project]/app/(dashboard)/upload-audio/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UploadAudioPage() {
    ...
    const [mode, setMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("free");
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApiUrl"])("/api/save-conversion"), {
                method: "POST",
                body: formData
            });
            setShowSuccess(true);
...
//# sourceMappingURL=app_%28dashboard%29_upload-audio_page_tsx_9c596462._.js.map