...
"[project]/app/api/save-conversion/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (isGuest) {
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO users (nipp, nama, role) 
            ...
            if (!user_nipp) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Invalid user session: NIPP missing"
                }, {
                    status: 401
                });
            }
        ...
        if (audioFile) {
            ...
            const uploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "uploads", "audio");
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO conversions (user_nipp, judul, text_input, mode, lang, provider, audio_path) 
             VALUES (?, ?, ?, ?, ?, ?, ?)`, [
            user_nipp,
            judul || null,
            text,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__57b07f30._.js.map